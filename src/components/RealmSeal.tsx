...
export default function RealmSeal({
  ...
  const dims = {
    sm: { box: 'size-11 text-[11px] leading-[1.15]', tier: 'text-[8.5px] -right-1 -bottom-1 size-4' },
    md: { box: 'size-14 text-[13px] leading-[1.15]', tier: 'text-[10px] -right-1.5 -bottom-1.5 size-5' },
    lg: { box: 'size-20 text-[17px] leading-[1.15]', tier: 'text-xs -right-2 -bottom-2 size-6' },
  }[size];
